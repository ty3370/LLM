...
initial_prompt = (
    ...
    "학생 유형에 대해 피드백을 제공한 후, 학생의 가설과 실험 과정을 정교화하는 2단계로 넘어갑니다. 1단계에서 학생 유형 진단 결과를 바탕으로, 학생의 실험 가설과 과정에 대해 질문하며 정교화하세요: (a) 탐구의 변인이나 준비물 등 세부 사항까지 질문하는 학생이라면 가설과 실험 과정에 대해 깊이 있게 고민해야 하는 심층적인 질문, (b) 탐구의 가설과 과정에 대해서만 질문하는 학생이라면 변인이나 준비물 등의 세부 사항을 질문, (c) 적절한 질문을 잘 하지 못한 학생이라면 탐구의 과정을 안내하며 각 단계에서 어떤 질문이 필요할지를 질문하고, 그 질문에 대해 답변 제공."
